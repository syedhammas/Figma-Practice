        ...
        <div className="w-full flex flex-col items-center">
            <section className=" flex flex-col items-center min-h-screen bg-[url('/hero4.png')] bg-cover bg-no-repeat relative">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 mx-24 gap-8 mt-16 justify content-center items-center">
                    ...
                    {/* Card 2 */}
                    <div className="relative shadow-lg flex items-center flex-col">
                        <div className="w-fit gap-2 mb-2 flex justify-center z-1 items-center bg-[#121326]">
                            <span className="w-2 h-2 bg-blue-200 rounded-full"></span>
                    ...
                    {/* Card 3 */}
                    <div className="relative shadow-lg flex items-center flex-col">
                        <div className="w-fit gap-2 mb-2 flex justify-center z-1 items-center bg-[#121225]">
                            <span className="w-2 h-2 bg-blue-200 rounded-full"></span>
                            <span className="uppercase text-white font-bold text-xl">
                                Hardware NVME y AMD
                            </span>
                    ...
                    {/* Card 4 */}
                    <div className="relative shadow-lg flex items-center flex-col">
                        <div className="w-fit gap-2 mb-2 flex justify-center z-1 items-center bg-[#100E22]">
                            <span className="w-2 h-2 bg-blue-200 rounded-full"></span>
                            <span className="uppercase text-white font-bold text-xl">
                                24/7 support
                            </span>
                    ...
                    {/* Card 5 */}
                    <div className="relative shadow-lg flex items-center flex-col">
                        <div className="w-fit gap-2 mb-2 flex justify-center z-1 items-center bg-[#181d43]">
                            <span className="w-2 h-2 bg-blue-200 rounded-full"></span>
                            <span className="uppercase text-white font-bold text-xl">
                    ...
                    {/* Card 6 */}
                    <div className="relative shadow-lg flex items-center flex-col">
                        <div className="w-fit gap-2 mb-2 flex justify-center z-1 items-center bg-[#171c41]">
                            <span className="w-2 h-2 bg-blue-200 rounded-full"></span>
                            <span className="uppercase text-white font-bold text-xl">
                ...
                <section className="w-full flex flex-col items-center py-24">
                    ...
                    <div className="relative shadow-lg flex items-center flex-col mt-12">
                        <div className="flex items-center justify-center mb-4 bg-[#161b3d] z-10">
                            <span className="w-2 h-2 bg-blue-200 rounded-full"></span>
            ...
            <section className="w-full flex flex-col items-center bg-[url('/arkbg.png')] bg-cover bg-no-repeat py-24 mx-28 relative">
